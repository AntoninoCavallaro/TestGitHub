...
public class CadastalCode
{
    public static Dictionary<string, string> CodiciCatastali;
    ...
    public static string GetCatastalCode(string chiave)
    {
        if (CodiciCatastali.TryGetValue(chiave, out string valore))
        {
            return valore;
        }
        else
        {
            throw new KeyNotFoundException($"Codice catastale non trovato per la chiave: {chiave}");
        }
    }
}